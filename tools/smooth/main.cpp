...
constexpr double participleAmount = 40;
constexpr double fullAngle = 4 * 3.1415;
constexpr double normal = participleAmount * 1000000 * fullAngle;
...
int main(int argc, char *argv[]) {
  ...
  //  const auto _first_file = "fon.txt";
